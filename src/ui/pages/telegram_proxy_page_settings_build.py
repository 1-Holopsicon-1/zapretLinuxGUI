...
def build_telegram_proxy_settings_panel(
    ...
    *,
    ...
    setup_open_btn.setIcon(qta.icon("mdi.telegram", color="#229ED9"))
    ...
    setup_copy_btn.setIcon(qta.icon("mdi.content-copy", color="#60cdff"))
    ...
    mtproxy_action_btn.setIcon(qta.icon("mdi.telegram", color="#229ED9"))
